...
?>
<div class="block large pad bg bg1 align-center" data-parallax="scroll" data-image-src="<?php echo $rootpath;?>images/block-bg/1.jpg?cache=0">
...
<div class="block huge pad bg bg5 nofade" data-parallax="scroll" data-image-src="<?php echo $rootpath;?>images/block-bg/5.jpg?cache=0">
	<div class="wrap">
		<div class="row">
...
<div class="block">
	<div class="wrap">
		...
		<div class="row">
			<a class="floor-fade" href="<?php echo $rootpath;?>classes/#rhythmic">
				<div class="rhythmicgymnastics">
					<h2>Rhythmic</h2>
				</div>
			</a
			><a class="floor-fade w2" href="<?php echo $rootpath;?>classes/#freerunning">
				<div class="freerunning">
					<h2>Freerunning</h2>
				</div>
			</a
			><a class="floor-fade" href="<?php echo $rootpath;?>classes/#parallelbars">
		...
		<div class="row">
			<a class="floor-fade" href="<?php echo $rootpath;?>classes/#trampoline">
